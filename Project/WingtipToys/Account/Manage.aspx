        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    <dt>Password:</dt>
                    <dd>
                       <asp:HyperLink NavigateUrl="/Account/ManagePassword"  Text="[Change]" Visible="false" ID="ChangePassword" runat="server" aria-describedby="change-password-link-hint" area-hidden="true"/>
                        <span id="change-password-link-hint" class="hidden">change password</span>
                        <asp:HyperLink NavigateUrl="/Account/ManagePassword" Text="[Create]" Visible="false" ID="CreatePassword" runat="server" aria-describedby="create-password-link-hint" area-hidden="true"/>
                    ...
                    <dd><%: LoginsCount %>
                        ...
                        <asp:HyperLink NavigateUrl="/Account/ManageLogins" Text="[Manage]" runat="server" role="link" 
                            aria-describedby="manage-password-link-hint"/>
                    </dd>
                    <%--
                    ...
                    <dd>        
                        <p>
                            There are no two-factor authentication providers configured. See <a href="http://go.microsoft.com/fwlink/?LinkId=313242" aria-describedby="two-factor-authentication-desrc-hint">this article</a>
